...
::: container
<form id="report-form">
    <input type="text" id="title" name="title" placeholder="Report Title" required>
    <br>
    <textarea id="description" name="description" rows="4" placeholder="Report Description" required></textarea>
    <br>
