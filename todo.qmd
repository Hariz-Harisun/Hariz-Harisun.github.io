...
-   <li><input type="checkbox" class="task" id="task1"> <label for="task1" class="task-label">Task 1</label></li>

-   <li><input type="checkbox" class="task" id="task2"> <label for="task2" class="task-label">Task 2</label></li>

-   <li><input type="checkbox" class="task" id="task3"> <label for="task3" class="task-label">Task 3</label></li>
